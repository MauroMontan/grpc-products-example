...
const (
	ProductService_GetProducts_FullMethodName = "/products.ProductService/GetProducts"
)
...
type ProductServiceClient interface {
	GetProducts(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ProductReply, error)
}
...
func (c *productServiceClient) GetProducts(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ProductReply, error) {
...
type ProductServiceServer interface {
	GetProducts(context.Context, *emptypb.Empty) (*ProductReply, error)
...
func (UnimplementedProductServiceServer) GetProducts(context.Context, *emptypb.Empty) (*ProductReply, error) {
